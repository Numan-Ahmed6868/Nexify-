          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-xs font-bold tracking-widest text-white/40 uppercase px-1">Full Name</label>
                <input
                  required
                  type="text"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold tracking-widest text-white/40 uppercase px-1">Email Address</label>
                <input
                  required
                  type="email"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold tracking-widest text-white/40 uppercase px-1">Project Type</label>
                <select
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 focus:outline-none focus:border-brand-primary transition-colors appearance-none"
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold tracking-widest text-white/40 uppercase px-1">Message</label>
                <textarea
                  required
                  rows={4}
              ...
              <button
                type="submit"
                className="w-full py-5 bg-brand-primary text-black font-black rounded-2xl flex items-center justify-center gap-3 hover:scale-[1.02] transition-transform shadow-xl shadow-brand-primary/20"
              >
                Send Message
                <Send size={20} />
              </button>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-6 group">
                  ...
                  <div className="space-y-1">
                    <p className="text-xs font-bold tracking-widest text-white/40 uppercase">Visit Us</p>
                    <p className="text-xl font-medium">Tech Hub, Silicon Valley East, Lahore, Pakistan</p>
                  </div>
                </div>
              </div>
            </div>
